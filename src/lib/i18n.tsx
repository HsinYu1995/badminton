...
export const en = {
  ...
  'discover.requestAlreadyWithdrawn': 'This request was already withdrawn.',
  ...
  'profile.alreadyLeftEvent': "You've already left this event.",
  ...
  'profile.eventIsFull': 'This event is full.',
  'profile.requestNoLongerAvailable': 'This request is no longer available.',
...
export const zhTW: Translations = {
  ...
  'discover.requestAlreadyWithdrawn': '此申請已被撤回。',
  ...
  'profile.alreadyLeftEvent': '您已退出此活動。',
